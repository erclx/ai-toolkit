...
- [Claude Code agent view](claude-agent-view.md): Managing background sessions, their groups, peek and attach, filter syntax, pinning, keyboard shortcuts, the shell verbs beside the view, and its operational limits
