...
Track what is being built and why, at the level of features and outcomes. No code-level steps or technical decisions. Those live in `.claude/ARCHITECTURE.md`. Update this doc whenever a task is started, completed, or scope changes.
