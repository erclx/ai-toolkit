...
function reportDepth(
  ...
  logInfo(
    'A heading breaks a run and so does a bold section marker at column zero, such as a line reading only Risks in bold. A colon-less one breaks when it runs to 30 characters or fewer, and an indented one stays prose.',
  )
