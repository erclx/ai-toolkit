...
main() {
  ...
  # `561-teach.md` shipped a `references/glossary.md` that had never existed.
  #
  ...
  run_check "cd $PROJECT_ROOT && bun src/cli.ts gov citations" "A path a rule cites does not resolve. Run bun src/cli.ts gov citations."
