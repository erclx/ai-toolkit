...
EOF
  ...
  log_add "cspell.json         missing"
  log_add ".shellcheckrc       missing"
  log_add ".lintstagedrc       missing"
  log_add ".husky/             missing"
  log_add "scripts/            missing"
  log_info ""
  log_info "Action:  gdev tooling base ."
  log_info "Expect:  Configs overwritten, missing files created, deps installed"
}
