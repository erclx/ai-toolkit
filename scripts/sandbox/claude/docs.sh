...
stage_setup() {
  ...
  "board-sweep")
    ...
    log_info "Context: two closed tasks on the board, each citing a plan in .claude/plans/"
    ...
    log_info "reaches the task the session or the prompt put in front of it."
    log_info ""
    log_info "Action:  /claude-docs"
    ...
    log_info "         Both plans archived, both Plan: lines retargeted"
    log_info ""
