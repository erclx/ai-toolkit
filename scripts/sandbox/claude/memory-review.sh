...
EOF
  ...
  log_info "         which the review file is deleted and the MEMORY.md rows for"
  log_info "         handled entries are gone. The declaration covers the propose"
  log_info "         pass alone, which is where a headless run stops."
}
