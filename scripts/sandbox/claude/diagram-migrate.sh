...
EOF
  ...
  log_info "Context: three H2 sections in one flat file, seeded .claude/diagrams/ holding index.md alone"
  ...
  log_info "Expect: .claude/diagrams/index.md regenerated, three entries under category headings"
