...
EOF
    ...
    log_info "Action:  /aitk:aitk-slides-draft 'ledger v1 overview deck'"
    log_info "Expect:  .claude/SLIDES.md drafted with a bold non-blue palette and varied layouts, then rendered to .claude/review/slides/, with a one-pass QA check"
    ;;
  "bare")
    cat <<'EOF' >README.md
# Toolbox
...
EOF
    ...
    log_info "Action:  /aitk:aitk-slides-draft 'toolbox launch deck'"
