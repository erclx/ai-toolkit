...
This body exists so a project that installed the plugin before the merge keeps resolving the old name for one sync cycle. It ships in `0.18.0` and is removed in `0.19.0`, along with `scripts/sandbox/claude/design-propose.sh`.
