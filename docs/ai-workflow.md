...
| `toolkit:claude-tasks`          | Add a task to `.claude/tasks/` or archive a shipped one out of the folder                                              |
