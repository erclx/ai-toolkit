...
| `500–599` | claude (markdown prose, .claude/ context, wireframe, and canonical-doc authoring) |
...
| Stack            | Extends | Rules                                                                                                                                |
| ---------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `base`           | -       | 000–070 core rules, 500–560 claude authoring (prose, context, wireframes, canonical docs)                                            |
