...
> Auto-generated by `bun run snapshot`. Refresh when structure meaningfully changes. Paste with REQUIREMENTS.md + ARCHITECTURE.md on new feature sessions only.
