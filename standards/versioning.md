...
| Tracked prose (e.g. context entries, standards, skill bodies) | conditional  | no                                  |
...
- A phase label in tracked prose is permitted only when its substance is restated inline beside it. A bare label carrying nothing beside it is forbidden, since a reader without the board has nothing to resolve it against.
