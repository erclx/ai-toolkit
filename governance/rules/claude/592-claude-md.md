...
- Route a rule failing either half to a context entry or a skill body rather than here. Firing is one axis of three, and `.claude/ARCHITECTURE.md` names the other two, conditional presence and updatability, which this rule does not restate.
