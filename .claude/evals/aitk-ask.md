...
- **Expected source:** `.claude/context/claude-plugin.md` and `wiki/claude-skills.md` both plausible. Either one alone is acceptable. Two-file `Source:` line is also acceptable.
