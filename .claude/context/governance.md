...
| `500–599` | claude (markdown prose, .claude/ context, wireframe, canonical-doc, task-board, skill, and readme authoring) |
...
| Stack            | Extends | Rules                                                                                                                                |
| ---------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `base`           | -       | 000–070 core rules, 500–580 claude authoring (prose, context, wireframes, canonical docs, tasks, skills, readme)                     |
