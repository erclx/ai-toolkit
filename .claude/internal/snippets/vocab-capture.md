Review this session for new terms worth adding to `wiki/concepts/rule-writing-vocabulary.md`. Append qualifying entries directly to the page.
...
2. Read `wiki/concepts/rule-writing-vocabulary.md` at that root.
