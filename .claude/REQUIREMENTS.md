...
- TypeScript with Commander for the CLI entry point and every domain
- Bash 4+ for sandbox provisioning, the verb scripts that read frontmatter in a loop, and hook functions
