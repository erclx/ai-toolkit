...
- Voice and word choice, which `.claude/standards/prose.md` states directly, and punctuation and formatting, which `.claude/standards/markdown.md` states directly. Read those files rather than loading this skill to reach them.
