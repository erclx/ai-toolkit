...
- Create the `.md` file in `standards/` following `.claude/standards/standard.md` for shape, frontmatter, and structure.
- Update the standards table in `.claude/context/standards.md`
...
- `.claude/standards/standard.md`: the meta-standard for a standard's shape and frontmatter
