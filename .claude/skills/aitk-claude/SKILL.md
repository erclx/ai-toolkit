...
- When a skill persists output to `.claude/` (plans, review, audits), follow Deriving the branch slug in `.claude/standards/skill.md`. Cite that section from the skill body and state which empty-case the skill takes, rather than restating the derivation.
