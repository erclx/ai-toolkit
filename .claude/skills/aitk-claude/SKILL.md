...
- When a skill persists output to `.claude/` (plans, review, audits), follow `.claude/standards/branch-slug.md`. Cite that standard from the skill body and state which empty-case the skill takes, rather than restating the derivation.
